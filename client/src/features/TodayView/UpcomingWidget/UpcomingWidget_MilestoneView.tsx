...
export default function UpcomingWidgetMilestoneView({milestone, index, max, boardTitle, boardId, sprintId}: Props) {
             ...
             <Grid container display='flex' flexGrow={1} sx={{padding: '5px'}} >
                <Grid item xs={1}
                    ...
                    display="flex" alignItems="center" flexDirection="column">
                        <Typography sx={{fontSize: '20px', color: 'grey.50'}} >&nbsp;M&nbsp;</Typography>
                    </Box>
                </Grid>
                <Grid item padding='5px 5px' xs={9} alignItems="center" textAlign={'left'}>
                    <Typography variant="body1" sx={{margin: '0px 15px', fontSize: '15px'}}>{milestone.description}</Typography> 
                    ...
                    {calculateOverdue(milestone.dueDate) ? 
                        <Typography variant="subtitle2" sx={{margin: '0px 15px', fontSize: '12px', color: '#e43329'}}>{"Past due: " + milestone.dueDate}</Typography>     
                    :
                        <Typography variant="subtitle2" sx={{margin: '0px 15px', fontSize: '12px'}}>{"Due date: " + milestone.dueDate}</Typography>     
                    } 
                </Grid>
                <Grid item xs={2}
                        display="flex" 
