...
export default function TodayWidgetTaskView({task, index, max, boardTitle, isLeftSide, boards}: Props) {
    ...
    const boxStyles = {
        background: task.currentState === 0 
        ? 'linear-gradient(90deg, rgba(231,104,72,1) 0%, rgba(207,67,43,1) 100%)' 
        : task.currentState === 1 ? 'linear-gradient(90deg, rgba(255,209,125,1) 0%, rgba(255,196,54,1) 100%)' 
