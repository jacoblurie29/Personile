...
export default function TodayWidgetAddTasksDialog({
  boards,
  handleOpenDialog,
}: Props) {
        ...
        >
          <>
            ...
            <Grid container>
              ...
              >
                {allTasks
                  .filter((task) => task.focused != true)
                  .map((task, index) => (
                    <TodayWidgetTaskView
                      task={task}
                      index={index}
                      max={
                        allTasks.filter((task) => task.focused != true).length -
                        1
                      }
                      boardTitle={
                        boards.find(
            ...
            <Button
              variant="contained"
              sx={{ margin: "10px", display: "flex", marginLeft: "auto" }}
