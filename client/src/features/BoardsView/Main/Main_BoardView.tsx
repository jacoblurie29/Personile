...
export default function BoardView() {
    ...
    return (
        <Box margin='20px 10px 0px 0px' overflow='auto' sx={{height: '85%'}}>
            <Grid container>
                ...
                <Zoom in={true} timeout={boards?.length === undefined ? 300 : (boards.length) * 500}> 
                    <Grid item xl={4} md={6} xs={12} sx={{display: 'flex', alignItems: 'center', justifyContent: 'center', height: {xs: '410px'}, paddingTop: '20px'}}>
