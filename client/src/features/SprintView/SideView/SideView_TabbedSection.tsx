    ...
    >
        ...
        <Grid item xs={4}>
          <Button
            ...
            sx={{
              ...
              borderRadius: "0px",
              backgroundColor:
                currentTab === 0 ? "rgba(0,0,0,0)" : "primary.main",
              ":hover": {
                backgroundColor: currentTab == 0 ? "grey.200" : "primary.dark",
              },
            }}
          >
            <InfoIcon
              sx={{ color: currentTab === 0 ? "grey.600" : "background.paper" }}
            />
          </Button>
        </Grid>
        <Grid item xs={4}>
          <Button
            ...
            sx={{
              ...
              borderRadius: "0px",
              backgroundColor:
                currentTab === 1 ? "rgba(0,0,0,0)" : "primary.main",
              ":hover": {
                backgroundColor: currentTab == 1 ? "grey.200" : "primary.dark",
              },
            }}
          >
            <EventAvailableIcon
              sx={{ color: currentTab === 1 ? "grey.600" : "background.paper" }}
            />
          </Button>
        </Grid>
        <Grid item xs={4}>
          <Button
            ...
            sx={{
              ...
              borderRadius: "0px",
              backgroundColor:
                currentTab === 2 ? "rgba(0,0,0,0)" : "primary.main",
              ":hover": {
                backgroundColor: currentTab == 2 ? "grey.200" : "primary.dark",
              },
            }}
          >
            <MessageIcon
              sx={{ color: currentTab === 2 ? "grey.600" : "background.paper" }}
            />
          </Button>
        </Grid>
      </Grid>
      {currentTab === 0 ? (
        <Box sx={{ padding: "20px" }}>
          <Typography
            variant="h3"
            sx={{ color: "grey.600", marginBottom: "5px" }}
          >
            Board name:
          </Typography>
          <Typography variant="h5" sx={{ color: "grey.600", fontWeight: 200 }}>
            &nbsp;&nbsp;&nbsp;{board?.name}
          </Typography>
          <Divider
            sx={{
          ...
          <Typography variant="h4" sx={{ color: "grey.600", fontWeight: 200 }}>
            &nbsp;&nbsp;&nbsp;{board?.description}
          </Typography>
          <Divider
            sx={{
          ...
          <Typography variant="h4" sx={{ color: "grey.600", fontWeight: 200 }}>
            &nbsp;&nbsp;&nbsp;{formatDateString(board?.startDate || "")}
          </Typography>
          <Divider
            sx={{
              backgroundColor: "grey.300",
          ...
          <Typography variant="h4" sx={{ color: "grey.600", fontWeight: 200 }}>
            &nbsp;&nbsp;&nbsp;
            {board?.endDate !== "" && formatDateString(board?.endDate || "")}
          </Typography>
          <Divider
            sx={{
              backgroundColor: "grey.300",
          ...
          <List dense>
            {board?.goals.map((goal, index) => (
              <ListItem key={"goal" + index}>
                <Typography
                  variant="h4"
                  sx={{ color: "grey.600", fontWeight: 200 }}
                >
                  &nbsp;&nbsp;&nbsp;<b>&#8226;</b>&nbsp;{goal.details}&nbsp;
                </Typography>
              </ListItem>
            ...
            {board?.milestones.map((milestone, index) => (
              <div key={"milestoneOuterDiv" + index}>
                ...
                <ListItem
                  ...
                  secondaryAction={
                    <Checkbox
                      checked={getTasksForMilestone(
                        milestone.milestoneEntityId
                      )?.every((t) => t.currentState === 2)}
                    />
                  }
                >
                  <Typography
                  ...
                  >
                    ...
                    {milestone.dueDate !== "" && (
                      <Typography
                        variant="caption"
                        sx={{ marginLeft: "40px", color: "background.paper" }}
                      >
                        {milestone.hardDeadline ? "Due Date:" : "Goal:"}&nbsp;
                        {milestone.dueDate.substring(0, 15)}
                      </Typography>
                    )}
                  </Typography>
                </ListItem>
                <ListItem sx={{ paddingLeft: "20px" }}>
                  <Grid container>
                    {getTasksForMilestone(milestone.milestoneEntityId)?.map(
                      (task, index) => (
                        <Grid
                          item
                          key={"milestone" + index}
                          ...
                          sx={{
                            ...
                            borderBottom:
                              index + 1 !==
                              getTasksForMilestone(milestone.milestoneEntityId)
                                ?.length
                                ? "1px solid lightgrey"
                                : "",
                            borderRadius: getMilestoneTaskBorders(
                              index,
                        ...
                        >
                          <Grid container alignItems="center" padding="2px">
                            <Grid item xs={1} height="20px"></Grid>
